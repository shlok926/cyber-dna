...
def download_report():
    ...
    pdf.drawString(40, height - 42, "CHETNASCAN AI")
    ...
    pdf.drawRightString(width - 40, height - 52, f"AUDIT ID: CSAI-{datetime.now().strftime('%m%d%H%M')}")
    ...
    pdf.drawRightString(width - 40, 42, "Generated by ChetnaScan AI Core Engine")
    ...
    return send_file(
        buffer,
        as_attachment=True,
        download_name="ChetnaScan_AI_Report.pdf",
...
def download_comprehensive_report():
    ...
    pdf.setFillColor(HexColor("#ffffff"))
    pdf.setFont("Helvetica-Bold", 22)
    pdf.drawString(40, height - 45, "CHETNASCAN AI")
    ...
    pdf.drawRightString(width - 40, height - 55, f"REPORT ID: CSAI-EXEC-{datetime.now().strftime('%m%d%H%M')}")
    ...
    pdf.setFillColor(HexColor("#64748b"))
    pdf.setFont("Helvetica", 7.5)
    pdf.drawString(40, 38, "ChetnaScan AI Integrated Core Report - Confidential")
    ...
    pdf.drawString(40, height - 35, "CHETNASCAN AI - INTEGRATED AUDIT REPORT")
    ...
    recs.append("Conduct a security profile evaluation at least once a quarter to update your ChetnaScan AI Shield.")
    ...
    return send_file(
        buffer,
        as_attachment=True,
        download_name="ChetnaScan_AI_Comprehensive_Audit.pdf",
        mimetype="application/pdf"
    )
